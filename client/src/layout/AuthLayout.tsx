...
const AuthLayout = () => {
    return (
        <div className="flex flex-col items-center justify-start pt-15 gap-8 w-full h-screen bg-linear-to-br from-emerald-900 via-black to-grass-950 text-white" >
            ...
            {/* Heading */}
            <div className="w-108 flex flex-col items-center justify-center text-center gap-3">
