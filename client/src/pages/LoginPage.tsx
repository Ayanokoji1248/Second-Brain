    ...
    return (
        <div className="w-96 rounded-xl bg-grass-950/20 py-6 px-6 mt-3">
            ...
            <form className="flex flex-col gap-4 mt-3">
                ...
                <button className="w-full bg-grass-600 p-2 rounded-md text-white font-semibold tracking-tight cursor-pointer hover:bg-grass-800 transition-all duration-300">Login</button>
            </form>
            <p className="text-sm mt-3 text-zinc-400 font-medium">Don't have an Account? <Link to={'/login'} className="font-bold text-grass-100 hover:text-grass-400 transition-all duration-300">Register</Link></p>
        </div>
    )
}
